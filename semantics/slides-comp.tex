...
\begin{frame}{More complex examples}
  ...
  Systems using logical inference are not robust to missing
  information: simpler techniques can be effective (partly because of
  choice of hypotheses in RTE).
\end{frame}
...
\begin{frame}{More examples}
  ...
  \begin{block}{Ex 4}
    \begin{itemize}
    \item[T:] The young boys are playing outdoors and the man is smiling nearby
    \item[H:] The kids are playing outdoors near a man with a smile
    \end{itemize}
  \end{block}
