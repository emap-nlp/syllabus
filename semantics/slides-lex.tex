...
\begin{frame}{Lexical meaning and meaning postulates}
  \begin{itemize}
  \item Some inferences (previous slides) validated on logical
    representation directly, most require lexical meaning.
  \item meaning postulates: e.g.,
    \[ \forall x [ \pred{bachelor}(x) \rightarrow \pred{man}(x) \wedge
      \pred{unmarried}(x)] \]
